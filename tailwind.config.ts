  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        "logo": ["20px", { lineHeight: "1.3", letterSpacing: "-0.02em", fontWeight: "500" }],
        "text-micro": ["10px", { lineHeight: "1.4", letterSpacing: "0.05em", fontWeight: "500" }],
      },
      spacing: {
        "section-gap": "128px",
        "section-bottom-mobile": "128px",
